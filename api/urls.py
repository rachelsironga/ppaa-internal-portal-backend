...
from api.modules.system.user_roles import (
    SystemAssignRoleListToUser,
    SystemAssignRoleUser,
    SystemGroupView,
...
urlpatterns = [
    ...
    path("system/permissions-by-app", SystemPermissionsByAppView.as_view(), name="system-permissions-by-app"),
]
