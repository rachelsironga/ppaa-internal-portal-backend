...
class BulkUserImportView(APIView):
    ...
    REQUIRED_COLS = [
        ...
        "PHONE_NO", "EMAIL", "DESIGNATION", "PF_NO", "CHECK_NO",
    ...
    def post(self, request):
        ...
        try:
            with transaction.atomic():
                ...
                existing_pf_numbers = set(
                    User.objects.values_list("pf_number", flat=True)
                )
                ...
                for row in df.itertuples(index=False):
                    ...
                    try:
                        ...
                        pf_number = row_data["PF_NO"]

                        if username in existing_usernames:
                            raise Exception("Username already exists")

                        if pf_number in existing_pf_numbers:
                            raise Exception("PF number already exists")
